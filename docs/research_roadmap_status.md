...
| 2. Fair baselines | Partial | Symmetric ECFP/Morgan + SGD logistic baseline, fair shared-split experiment launcher, repeated-seed comparison support. | XGBoost, GCN/GIN, directed MPNN, scaffold-disjoint evaluation, speed/memory measurements, and actual baseline runs. |
...
| 7. Strong evaluation | Pending execution | Split manifests, predictions, plots, and repeated-seed bootstrap infrastructure exist. | Five-seed results, scaffold-disjoint split, statistical tests, error analysis, efficiency measurement, and external evaluation. |
